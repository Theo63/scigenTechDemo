...
export default function RegisterForm({registrationSuccess}) {
...
const handleSubmit = async (event) => {
    ...
    registrationSuccess(); //to update the registered speakers list
            ...
            <form onSubmit={handleSubmit}>
                <div className="form-content">
                    <div className='form-element'>
                        <label htmlFor="name" className="required">Speaker Name</label>
                        <input 
                            type="text" 
                            id="name" 
                            name="name" 
                    ...
                    <div className='form-element'>
                        <label htmlFor="topic" className="required">Topic</label>
                        <input 
                            type="text" 
                            id="topic" 
                            name="topic" 
